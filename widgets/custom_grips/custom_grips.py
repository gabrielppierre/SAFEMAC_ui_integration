...
class Widgets(object):
    def top(self, Form):
        ...
        self.top_left.setStyleSheet(u"background-color: #000033;")
        ...
        self.top_right.setStyleSheet(u"background-color: #000033;")
    ...
    def bottom(self, Form):
        ...
        self.bottom_left.setStyleSheet(u"background-color: #000033;")
        ...
        self.bottom.setStyleSheet(u"background-color: #000033;")
        ...
        self.bottom_right.setStyleSheet(u"background-color: #000033;")
    ...
    def left(self, Form):
        ...
        self.leftgrip.setStyleSheet(u"background-color: #ffff00;")
    ...
    def right(self, Form):
        ...
        self.rightgrip.setStyleSheet(u"background-color: #ffff00;")
